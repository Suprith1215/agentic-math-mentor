...
A reliable multimodal AI system that solves **JEE-style math problems** using **RAG**, **multi-agent reasoning**, **human-in-the-loop validation**, and **long-term memory**.
...
⚠️ Difficulty strictly limited to **JEE-level**.
...
| Intent Router Agent | Determines topic & solving strategy |
| Solver Agent | Solves using RAG + tools |
| Verifier Agent | Checks correctness & edge cases |
